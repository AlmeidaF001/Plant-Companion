...
@dso_cache = dso_local local_unnamed_addr global [642 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 384161231, ; hash 0x16e5d5cf, from name: aot-PlantCompanion.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 721780982, ; hash 0x2b0580f6, from name: aot-PlantCompanion
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PlantCompanion.dll.so
		ptr null; void* handle (0x0)
	}, ; 92
	...
	%struct.DSOCacheEntry {
		i64 1032768218, ; hash 0x3d8ecada, from name: PlantCompanion.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PlantCompanion.dll.so
		ptr null; void* handle (0x0)
	}, ; 147
	...
	%struct.DSOCacheEntry {
		i64 1818960736, ; hash 0x6c6b2360, from name: PlantCompanion
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PlantCompanion.dll.so
		ptr null; void* handle (0x0)
	}, ; 260
	...
	%struct.DSOCacheEntry {
		i64 2261093832, ; hash 0x86c58dc8, from name: libaot-PlantCompanion.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PlantCompanion.dll.so
		ptr null; void* handle (0x0)
	}, ; 339
	...
	%struct.DSOCacheEntry {
		i64 3934932219, ; hash 0xea8a4cfb, from name: libaot-PlantCompanion
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PlantCompanion.dll.so
		ptr null; void* handle (0x0)
	}, ; 589
